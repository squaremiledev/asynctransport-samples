 ...
 return MsgDirection.NULL_VAL;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasRefMsgType())
        {
            ...
            builder.append(refMsgType(), 0, refMsgTypeLength());
            builder.append("\",\n");
        }
        ...
        if (hasRefApplVerID())
        {
            ...
            builder.append(refApplVerID(), 0, refApplVerIDLength());
            builder.append("\",\n");
        }
        ...
        if (hasRefCstmApplVerID())
        {
            ...
            builder.append(refCstmApplVerID(), 0, refCstmApplVerIDLength());
            builder.append("\",\n");
        }
    ...
    public MsgTypesGroupEncoder toEncoder(final MsgTypesGroupEncoder encoder)
    {
        ...
        if (hasRefMsgType())
        {
            encoder.refMsgType(refMsgType(), 0, refMsgTypeLength());
        }

        if (hasMsgDirection())
        {
            encoder.msgDirection(msgDirection());
        }

        if (hasRefApplVerID())
        {
            encoder.refApplVerID(refApplVerID(), 0, refApplVerIDLength());
        }

        if (hasRefCstmApplVerID())
        {
            encoder.refCstmApplVerID(refCstmApplVerID(), 0, refCstmApplVerIDLength());
        }
        return encoder;
    }
