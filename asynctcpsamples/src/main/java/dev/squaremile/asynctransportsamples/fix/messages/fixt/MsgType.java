...
public enum MsgType implements StringRepresentable
{
    ...
    static
    {
        ...
        stringMap.put("BI", TRADING_SESSION_LIST_REQUEST);
        stringMap.put("BJ", TRADING_SESSION_LIST);
        stringMap.put("BK", SECURITY_LIST_UPDATE_REPORT);
        stringMap.put("BL", ADJUSTED_POSITION_REPORT);
        stringMap.put("BM", ALLOCATION_INSTRUCTION_ALERT);
        stringMap.put("BN", EXECUTION_ACKNOWLEDGEMENT);
        stringMap.put("BO", CONTRARY_INTENTION_REPORT);
        stringMap.put("BP", SECURITY_DEFINITION_UPDATE_REPORT);
    ...
    public static MsgType decode(final String representation)
    {
        ...
        case "BI": return TRADING_SESSION_LIST_REQUEST;
        case "BJ": return TRADING_SESSION_LIST;
        case "BK": return SECURITY_LIST_UPDATE_REPORT;
        case "BL": return ADJUSTED_POSITION_REPORT;
        case "BM": return ALLOCATION_INSTRUCTION_ALERT;
        case "BN": return EXECUTION_ACKNOWLEDGEMENT;
        case "BO": return CONTRARY_INTENTION_REPORT;
        case "BP": return SECURITY_DEFINITION_UPDATE_REPORT;
        default:
            return ARTIO_UNKNOWN;
        }
    }
