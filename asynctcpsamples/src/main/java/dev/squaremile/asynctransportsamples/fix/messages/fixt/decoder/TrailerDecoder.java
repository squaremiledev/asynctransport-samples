...
public class TrailerDecoder extends CommonDecoderImpl
{
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        builder.append(checkSum(), 0, checkSumLength());
        builder.append("\",\n");
    ...
    public TrailerEncoder toEncoder(final TrailerEncoder encoder)
    {
        ...
        if (hasSignature())
        {
            encoder.signatureAsCopy(signature(), 0, signatureLength());
            encoder.signatureLength(signatureLength());
        }

        encoder.checkSum(checkSum(), 0, checkSumLength());        return encoder;
    }
